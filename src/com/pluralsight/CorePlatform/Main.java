...
public class Main {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        */
        ...
        System.out.println("acctjulie id:  " + acctjulie.getId() + " || acctjulie balance:  " + acctjulie.getBalance());
        acctjulie.deposit(250);
        System.out.println("After deposit");
        System.out.println("acctjulie id:  " + acctjulie.getId() + " || acctjulie balance:  " + acctjulie.getBalance());

        saveAccount(acctjulie, "account.dat");

        BankAccount acct3 = loadAccount("account.dat");
        System.out.println("acct3 id:  " + acct3.getId() + " || acct3 balance:  " + acct3.getBalance());
